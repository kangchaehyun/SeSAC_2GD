...
let me2 = {
  ...
  greeting: function () {
    console.log(
      `안녕하세요, 제이름은 ${this.name} 이고요, 키는 ${this.height}입니다.`
    );
  },
};
...
console.log(addNumber(1, 2, 3, 4, 5, 6, 7, 100));
const result = addNumber(1, 2, 3, 4, 5, 6);
console.log(result);

function introduce(name, like = "밥", hate, goodAt) {
  console.log(` 내 이름은 ${name}입니다.`);
  console.log(` 좋아하는것은 ${like}입니다.`);
  console.log(` 싫어하는것은 ${hate}입니다.`);
